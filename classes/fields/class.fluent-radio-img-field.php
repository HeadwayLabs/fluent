...
add_action('fluent/options/field/radio-img/render', array('Fluent_Radio_Img_Field', 'render'), 1, 2);

/**
 * Fluent_Radio_Img_Field simple radio image select field.
 */
class Fluent_Radio_Img_Field extends Fluent_Field{
