...
add_action('fluent/options/field/color/render', array('Fluent_Color_Field', 'render'), 1, 2);
add_action('fluent/options/field/color/enqueue', array('Fluent_Color_Field', 'enqueue'));

/**
 * Fluent_Color_Field WordPress color picker field.
 */
class Fluent_Color_Field extends Fluent_Field{
