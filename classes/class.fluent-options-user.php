...
/**
 * Fluent_Options_User. Create and stores fields and sections.
 */
class Fluent_Options_User extends Fluent_Options{
    ...
    public function __construct( $args = array(), $sections = array() ){
        ...
        $this->args = $this->parse_args( $args, $this->default_args(), 'fluent/options/user/args' );
        
        //prepare sections and fields before merging values
        $sections = $this->parse_args( $sections, array(), 'fluent/options/user/'.$this->args['option_name'].'/sections' );
    ...
    public function settings_updated(){
        echo '<div class="updated"><p><strong>'.__('User Settings Saved.', $this->domain).'</strong></p></div>';   
    }
