...
add_action('fluent/options/field/gallery/render', array('Fluent_Gallery_Field', 'render'), 1, 2);
add_action('fluent/options/field/gallery/enqueue', array('Fluent_Gallery_Field', 'enqueue'), 1, 2);

/**
 * Fluent_Gallery_Field WordPress Media gallery select field.
 */
class Fluent_Gallery_Field extends Fluent_Field{
    ...
    public static function field_data(){
        $self = new self;
        return array(
            'edit_title' => __('Add/Edit Gallery', $self->domain),
            'remove_title' => __('Delete Gallery', $self->domain)
        );
    }
