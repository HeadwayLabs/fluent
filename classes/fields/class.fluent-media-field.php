...
add_action('fluent/options/field/media/render', array('Fluent_Media_Field', 'render'), 1, 2);
add_action('fluent/options/field/media/enqueue', array('Fluent_Media_Field', 'enqueue'), 1, 2);

/**
 * Fluent_Media_Field WordPress Media uploader field.
 */
class Fluent_Media_Field extends Fluent_Field{
    ...
    public static function enqueue( $data = array(), $field_data = array() ){
        wp_enqueue_media();
        wp_localize_script( 'fluent-options-js', 'fluent_media', array(
