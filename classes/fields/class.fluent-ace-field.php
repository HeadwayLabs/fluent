...
add_action('fluent/options/field/ace/render', array('Fluent_Ace_Field', 'render'), 1, 2);
add_action('fluent/options/field/ace/enqueue', array('Fluent_Ace_Field', 'enqueue'));

/**
 * Fluent_Ace_Field code editor field using ace.
 */
class Fluent_Ace_Field extends Fluent_Field{
    ...
    public static function enqueue( $data = array(), $field_data = array() ){
        $self = new self;
        wp_enqueue_script('ace-editor', Fluent_Base::$url . 'assets/vendor/ace/src-min-noconflict/ace.js', array('jquery'), $self->version, false);
    }
